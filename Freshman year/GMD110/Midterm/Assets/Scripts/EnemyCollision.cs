...
public class EnemyCollision : MonoBehaviour
{
    ...
    {
        if (collision.gameObject.tag == "Player" || collision.gameObject.tag == "Laser")//if the object it collided into is the player or a laser
        {
            ...
            //GameManager.singleton.UnlistEnemy(gameObject); //remove enemy reference from activeEnemyList (that lives in the singleton GameManager object) PROBLEM HERE
        }
